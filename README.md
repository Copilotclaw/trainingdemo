...
| [rag-techniques-ollama.ipynb](rag-techniques-ollama.ipynb) | 🔬 **Advanced RAG Techniques** — HyDE, MultiQuery, Step-Back, Re-Ranking, BM25, Dense Embedding with Ollama | <a href="https://colab.research.google.com/github/Copilotclaw/trainingdemo/blob/main/rag-techniques-ollama.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a> | *requires Ollama* |
