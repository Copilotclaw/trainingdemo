...
| [simple-rag-demo-ollama.ipynb](simple-rag-demo-ollama.ipynb) | 🦙 **Local RAG with Ollama** — same pipeline but with real LLM generation, fully offline | <a href="https://colab.research.google.com/github/Copilotclaw/trainingdemo/blob/main/simple-rag-demo-ollama.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a> | <a href="https://htmlpreview.github.io/?https://github.com/Copilotclaw/trainingdemo/blob/main/ollama-colab-explainer.html" target="_blank"><img src="https://img.shields.io/badge/📖_Colab_Setup-View-f59e0b?style=flat-square&logo=html5&logoColor=white" alt="Ollama Colab Setup"/></a> |
...
| [bm25-explainer.ipynb](bm25-explainer.ipynb) | 🔍 **BM25 vs Embeddings** — why keyword search still wins for product data; hands-on BM25 from scratch + live comparison | <a href="https://colab.research.google.com/github/Copilotclaw/trainingdemo/blob/main/bm25-explainer.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a> | *(no API key needed!)* |
...
| [ragas-evaluation-ollama.ipynb](ragas-evaluation-ollama.ipynb) | 📏 **RAGAS Evaluation** — score your RAG pipeline on Faithfulness, Answer Relevancy, Context Precision & Recall using Ollama — no API key needed | <a href="https://colab.research.google.com/github/Copilotclaw/trainingdemo/blob/main/ragas-evaluation-ollama.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a> | *(after rag-techniques!)* |
| [ragas-evaluation-guide.ipynb](ragas-evaluation-guide.ipynb) | 📊 **RAGAS Evaluation Guide** — comprehensive walkthrough of all 5 RAGAS metrics (OpenAI + Ollama), diagnostic table, multi-question examples | <a href="https://colab.research.google.com/github/Copilotclaw/trainingdemo/blob/main/ragas-evaluation-guide.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a> | *(deep dive into RAGAS!)* |
| [ragas-grok-tutorial.ipynb](ragas-grok-tutorial.ipynb) | 🦾 **RAGAS + Grok Tutorial** — evaluate your RAG pipeline with the free Grok API (xAI); all 5 metrics, climate-science sample data, per-question score breakdown, good vs bad answer analysis | <a href="https://colab.research.google.com/github/Copilotclaw/trainingdemo/blob/main/ragas-grok-tutorial.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a> | *(free Grok key required)* |
| [ragas-ali-tutorial.ipynb](ragas-ali-tutorial.ipynb) | 🐉 **RAGAS + Alibaba Qwen Tutorial** — same 5-metric RAGAS evaluation using the Alibaba DashScope Qwen API (OpenAI-compatible); generous free tier, no second key for embeddings | <a href="https://colab.research.google.com/github/Copilotclaw/trainingdemo/blob/main/ragas-ali-tutorial.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a> | *(DashScope key required)* |
| [ragmcp/GraphRAG/Historical_GraphRAG_Demo - Copy.ipynb](ragmcp/GraphRAG/Historical_GraphRAG_Demo%20-%20Copy.ipynb) | 🕸️ **Historical GraphRAG** — build a knowledge graph from historical texts using LLMs + Ollama, fully self-contained | <a href="https://colab.research.google.com/github/Copilotclaw/trainingdemo/blob/main/ragmcp/GraphRAG/Historical_GraphRAG_Demo%20-%20Copy.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a> | <a href="https://htmlpreview.github.io/?https://github.com/Copilotclaw/trainingdemo/blob/main/ragmcp/GraphRAG/graph-rag-explainer.html" target="_blank"><img src="https://img.shields.io/badge/📖_Explainer-View-7c3aed?style=flat-square&logo=html5&logoColor=white" alt="View Graph RAG Explainer"/></a> <a href="https://htmlpreview.github.io/?https://github.com/Copilotclaw/trainingdemo/blob/main/ragmcp/GraphRAG/graphrag-deep-explainer.html" target="_blank"><img src="https://img.shields.io/badge/🔬_Deep_Dive-View-dc2626?style=flat-square&logo=html5&logoColor=white" alt="Deep Dive Explainer"/></a> |
| [graphrag-neo4j-demo.ipynb](graphrag-neo4j-demo.ipynb) | 🗄️ **GraphRAG with Neo4j** — install Neo4j Community in Colab, build a knowledge graph, query it with LangChain `Neo4jGraph` + `GraphCypherQAChain`; includes vector index + semantic search (Groq free tier LLM) | <a href="https://colab.research.google.com/github/Copilotclaw/trainingdemo/blob/main/graphrag-neo4j-demo.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a> | *(free Groq key optional)* |
| [agentic-rag-demo.ipynb](agentic-rag-demo.ipynb) | 🤖 **Agentic RAG with Grok + LangGraph** — self-correcting pipeline: Retrieve → Generate → Evaluate → loop until verified; uses Grok structured output for hallucination detection | <a href="https://colab.research.google.com/github/Copilotclaw/trainingdemo/blob/main/agentic-rag-demo.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a> | *(xAI API key required)* |
| [autogen-agentic-rag-demo.ipynb](autogen-agentic-rag-demo.ipynb) | 🏢 **Agentic RAG with Microsoft AutoGen + Grok** — same Evaluator-Optimizer loop but using AutoGen's conversational FSM: agents literally talk to each other; a Python speaker-selection function replaces graph edges | <a href="https://colab.research.google.com/github/Copilotclaw/trainingdemo/blob/main/autogen-agentic-rag-demo.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a> | *(compare with LangGraph!)* |
| [Teaching_Agentic_Retrieval_in_Colab.ipynb](Teaching_Agentic_Retrieval_in_Colab.ipynb) | 🧑‍🏫 **Teaching Agentic Retrieval in Colab** — step-by-step introduction to agentic retrieval pipelines, designed for teaching/classroom use | <a href="https://colab.research.google.com/github/Copilotclaw/trainingdemo/blob/main/Teaching_Agentic_Retrieval_in_Colab.ipynb" target="_blank"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a> | *(classroom-ready!)* |
